...
const ARRAY_MAPPING: Record<number, Record<string, { field: string, value: string }>> = {
  ...
  3: {
    ...
    "madera": { field: "produccionOpciones", value: "madera" },
    "leña": { field: "produccionOpciones", value: "lena" },
    "castaña": { field: "produccionOpciones", value: "castana" },
    "vid": { field: "produccionOpciones", value: "vid" },
    "frutícola (cereza, pera, manzana)": { field: "produccionOpciones", value: "fruticola" },
    "hortícola (pimiento, cebolla)": { field: "produccionOpciones", value: "horticola" },
    "pasto / ganadera": { field: "produccionOpciones", value: "pasto_ganadera" },
    "productos apícolas (miel, polen, propóleo)": { field: "produccionOpciones", value: "apicola" },
