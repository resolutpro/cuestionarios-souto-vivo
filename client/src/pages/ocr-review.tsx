...
export default function OcrReviewPage() {
  ...
  useEffect(() => {
    if (submission) {
      ...
      // Obtenemos los objetivos actuales o iniciamos un array vacío
      const objetivos = new Set(data.objetivosModelo || []);

      // LÓGICA DE CORRECCIÓN:
      // 1. Si hay datos en 'produccionPrincipal', asegurar que la casilla 'produccion' esté marcada
      if (data.produccionPrincipal && data.produccionPrincipal.length > 0) {
        objetivos.add("produccion");
      }

      // 2. Si hay texto en 'otrosObjetivosTexto', asegurar que la casilla 'otros' esté marcada
      if (
        data.otrosObjetivosTexto &&
        data.otrosObjetivosTexto.trim().length > 0
      ) {
        objetivos.add("otros");
      }

      // Guardamos el array actualizado en los datos del formulario
      data.objetivosModelo = Array.from(objetivos);
  ...
  const updateSubmissionMutation = useMutation({
    ...
    onSuccess: () => {
      queryClient.invalidateQueries({
        queryKey: ["/api/submissions", submission?.id],
      });
  ...
  if (!job || !submission)
    return <div>No se encontró la información del trabajo o cuestionario</div>;
            ...
            <div className="space-y-8">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      Información de contacto y perfil del solicitante
                    </p>
                  </div>
                </div>
              ...
              <div className="space-y-4">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      Datos catastrales y características de la finca
                    </p>
                  </div>
                </div>
                <div className="grid gap-4 pl-12">
              ...
              <div className="space-y-4">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      Identifica las necesidades y el modelo agroforestal
                      deseado
                    </p>
                  </div>
                </div>
                <div className="grid gap-4 pl-12">
                  {renderFieldInput(
                    "Principales necesidades de la finca (puede marcar varias)",
                    "necesidades",
                    "checkbox-array",
                    [
                      {
                  ...
                  {((formData.necesidades as string[]) || []).includes(
                    "otras",
                  ) && (
                    <div className="space-y-1">
                      <Label className="text-sm font-medium">
                  ...
                  {renderFieldInput(
                    "¿Qué modelo agroforestal le gustaría conseguir? (puede marcar varios)",
                    "objetivosModelo",
                    "checkbox-array",
                    [
                  ...
                  {((formData.objetivosModelo as string[]) || []).includes(
                    ...
                    <div className="pl-6 border-l-2 border-primary/20 space-y-4 pt-2 pb-2">
                      {renderFieldInput(
                        "Si es producción, marcar opciones:",
                        "produccionPrincipal",
                        "checkbox-array",
                        [
              ...
              <div className="space-y-4">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h3 className="text-lg font-bold">
                      5. Interés y Compromiso
                    </h3>
                    <p className="text-sm text-muted-foreground">
                      Nivel de participación e interés en el proyecto
                    </p>
                  </div>
                </div>
                <div className="grid gap-4 pl-12">
                  {renderFieldInput(
                    "Grado de interés en participar en un proyecto piloto",
                    "gradoInteres",
                    "enum",
                    [
                  ...
                  {renderFieldInput(
                    "¿En qué nivel estaría dispuesto/a que actúe el proyecto?",
                    "nivelActuacion",
                    "enum",
                    [
                      {
                        value: "solo_diagnostico",
                        label: "Solo diagnóstico y propuesta técnica",
                      },
                      {
                        value: "implantacion",
                  ...
                  {renderFieldInput(
                    "Disponibilidad para (marcar lo que proceda)",
                    "disponibilidad",
                    "checkbox-array",
                    [
                      {
                        value: "reuniones",
                        label: "Asistir a reuniones o talleres",
                      },
                      {
                        value: "visitas",
                        label: "Recibir visitas técnicas en la finca",
                      },
                      {
                        value: "seguimiento",
                        label: "Colaborar en el seguimiento del proyecto",
                      },
                    ],
                  )}
                  {renderFieldInput(
                    "¿Existe previsión de relevo generacional en los próximos 5-10 años?",
                    "relevoGeneracional",
                    "enum",
                    [
                      {
                        value: "si_familiares",
                        label: "Sí, hay familiares o personas interesadas",
                      },
                      {
                      ...
                      {
                        value: "buscando",
                        label: "Estoy buscando a alguien que quiera trabajarla",
                      },
                    ],
                  )}
                </div>
              ...
              <div className="space-y-4">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      Formación que le gustaría recibir
                    </p>
                  </div>
                </div>
                <div className="grid gap-4 pl-12">
                  {renderFieldInput(
                    "¿En qué aspectos le gustaría recibir formación?",
                    "formacion",
                    "checkbox-array",
                    [
                      ...
                      {
                        value: "carbono",
                        label: "Plantaciones de fijación de carbono",
                      },
                      {
                        value: "comercializacion",
                        label: "Comercialización de productos",
                      },
                      { value: "ayudas", label: "Tramitación de ayudas" },
                      {
                        value: "legislacion",
                        label: "Legislación y fiscalidad",
                      },
                    ],
                  )}
                  <div className="space-y-1">
              ...
              <div className="space-y-4">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      Capacitación y visión comunitaria
                    </p>
                  </div>
                </div>
                <div className="grid gap-4 pl-12">
                  <div className="space-y-2">
                    <p className="text-sm font-semibold text-primary">
                      Modelos de colaboración y gestión comunitaria
                    </p>
                    {renderFieldInput(
                      ...
                      [
                        {
                          value: "si_agrupacion",
                          label: "Sí, me interesa integrarme en una agrupación",
                        },
                        {
                          value: "si_puntuales",
                          label: "Sí, pero solo para acciones puntuales",
                        },
                        {
                          value: "no_individual",
                          label: "No, prefiero gestión individual",
                        },
                        {
                          value: "no_se_asesoria",
                          label: "No lo sé, necesitaría asesoramiento",
                        },
                      ],
                    )}
                  </div>
                  <Separator />
                  {renderFieldInput(
                    "¿Considera que el tamaño/dispersión de sus fincas es un obstáculo?",
                    "minifundio",
                    "enum",
                    [
                      ...
                      {
                        value: "no_adecuado",
                        label: "No, el tamaño es adecuado",
                      },
                    ],
                  )}
                  <Separator />
                  {renderFieldInput(
                    "¿Cedería la gestión mediante Banco de Tierras si no puede trabajarla?",
                    "cesionTierras",
                    "enum",
                    [
                      {
                        value: "si_contrato",
                        label: "Sí, bajo contrato de arrendamiento o cesión",
                      },
                      {
                        value: "si_municipio",
                  ...
                  <Separator />
                  {renderFieldInput(
                    "Gobernanza y Comunidad ¿Cómo cree que el proyecto Souto Vivo podría mejorar la convivencia y la economía del pueblo? (Puede marcar varias opciones):",
                    "gobernanzaComunidad",
                    "checkbox-array",
                    [
                      {
                  ...
                  {renderFieldInput(
                    "Otras sugerencias de gobernanza",
                    "gobernanzaOtro",
                  )}
                </div>
              </div>
                ...
                <div className="grid gap-4 pl-12">
                  <div className="flex items-start space-x-3 space-y-0 border p-4 rounded-md">
                    ...
                    <div className="grid gap-1.5 leading-none">
                      ...
                      <p className="text-sm text-muted-foreground">
                        Sus datos serán tratados conforme al RGPD para la
                        gestión del proyecto Souto Vivo
                      </p>
                    </div>
                  </div>
